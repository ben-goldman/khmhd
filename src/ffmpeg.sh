...
ffmpeg -framerate 25 -pattern_type glob -i 'BEk*.jpg' -c:v libx264 -pix_fmt yuv420p BEk.mp4
ffmpeg -framerate 25 -pattern_type glob -i 'UEk*.jpg' -c:v libx264 -pix_fmt yuv420p UEk.mp4
